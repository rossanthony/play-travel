...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[CacheLayer].to[SSDBCacheLayer] //bind[CacheLayer].to[PlayCacheLayer]
...
//      clefProvider
  ...
  /**
    ...
    *
    * @param cacheLayer cachelayer info
