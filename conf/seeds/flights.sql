...
INSERT INTO `scheduled_flight` (`flightId`, `departureDate`, `arrivalDate`, `economySeats`, `businessSeats`)
VALUES
	(1, '2016-04-13', '2016-04-13', 90, 10),
	(1, '2016-04-20', '2016-04-20', 90, 10),
	(1, '2016-04-27', '2016-04-27', 90, 10),
	(1, '2016-05-04', '2016-05-04', 90, 10);
...
INSERT INTO `scheduled_flight` (`flightId`, `departureDate`, `arrivalDate`, `economySeats`, `businessSeats`)
VALUES
	(2, '2016-04-11', '2016-04-11', 90, 10),
	(2, '2016-04-18', '2016-04-18', 90, 10),
	(2, '2016-04-25', '2016-04-25', 90, 10),
	(2, '2016-05-02', '2016-05-02', 90, 10);
...
INSERT INTO `scheduled_flight` (`flightId`, `departureDate`, `arrivalDate`, `economySeats`, `businessSeats`)
VALUES
	(3, '2016-04-13', '2016-04-13', 90, 10),
	(3, '2016-04-20', '2016-04-20', 90, 10),
	(3, '2016-04-27', '2016-04-27', 90, 10),
	(3, '2016-05-04', '2016-05-04', 90, 10);